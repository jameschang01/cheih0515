...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.ShowStringButton = QtWidgets.QPushButton(Dialog)
        self.ShowStringButton.setGeometry(QtCore.QRect(370, 450, 111, 31))
        self.ShowStringButton.setStyleSheet("background-color: rgb(130,135,139);\n"
"color: rgb(255, 255, 255);")
        self.ShowStringButton.setObjectName("ShowStringButton")
        self.PressMeButton = QtWidgets.QPushButton(Dialog)
        self.PressMeButton.setGeometry(QtCore.QRect(720, 450, 111, 31))
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.ShowStringButton.setText(_translate("Dialog", "show string"))
